/**
 * System prompt for the "Otvaranje firme" chat flow.
 * Extracted from route.ts for maintainability.
 *
 * Uses a factory function so the date is fresh per request
 * (module-level template literals freeze at cold-start time).
 */
