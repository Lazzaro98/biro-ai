...
export default function FloatingPeople() {
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none hidden lg:flex fixed inset-x-0 top-[18vh] justify-center z-[1] opacity-60"
    >
      <div className="flex items-center gap-6 text-xs text-muted select-none">
